class KategorisController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @kategori.save
        format.html { redirect_to @kategori, notice: 'Kategori berhasil dibuat' }
  ...
  def update
    respond_to do |format|
      if @kategori.update(kategori_params)
        format.html { redirect_to @kategori, notice: 'Kategori berhasil diedit' }
  ...
  def destroy
    @kategori.destroy
    respond_to do |format|
      format.html { redirect_to kategoris_url, notice: 'Kategori berhasil dihapus' }
  ...
  private
    ...
    def kategori_params
      params.require(:kategori).permit(:nama)
    end
end
